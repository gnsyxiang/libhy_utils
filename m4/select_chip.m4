...
AC_DEFUN([SELECT_CHIP],
    [
        ...
        AC_ARG_WITH([chip],
                    [AS_HELP_STRING([--with-chip=@<:@pc-chip|MC6810E|mx6ull|stm32h7xx|rk3568|SV823|at32f4xx@:>@],
                                    [select chip about @<:@pc-chip|MC6810E|mx6ull|stm32h7xx|rk3568|SV823|at32f4xx@:>@ @<:@default=pc-chip@:>@])],
                    [],
                    [with_chip=pc-chip])
        ...
        case "$with_chip" in
            ...
            ;;
            *)
                AC_MSG_ERROR([bad value ${with_chip} for --with-chip=@<:@pc-chip|MC6810E|mx6ull|stm32h7xx|rk3568|SV823|at32f4xx@:>@])
            ;;
        esac
